...
public class Ants {
     ...
     */
    public Set<Tile> getEnemyAntTiles() {
     ...
     */
    public void clearEnemyAntTiles() {
     ...
     */
    public void clearFoodTiles() {
        for (Tile foodTile : foodTiles) {
            map[foodTile.getRow()][foodTile.getCol()] = Ilk.LAND;
        }
        foodTiles.clear();
    }
